...
export default function Home() {
  ...
  return (
    <div className="flex flex-row w-full h-full items-start md:items-center justify-items-center min-h-screen p-2 md:p-8 pb-20 font-[family-name:var(--font-geist-sans)]">
